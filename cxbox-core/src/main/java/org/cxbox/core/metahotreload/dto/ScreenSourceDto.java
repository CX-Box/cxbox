...
package org.cxbox.core.metahotreload.dto;
...
public class ScreenSourceDto {
	...
	/**
	 * used only if cxbox.meta.view-allowed-roles-enabled=true (see {@link org.cxbox.core.metahotreload.conf.properties.MetaConfigurationProperties#viewAllowedRolesEnabled})
	 */
	private int order = 0;
