...
public class ZDT2LDTDeserializer extends JsonDeserializer<LocalDateTime> {

	public static final ZDT2LDTDeserializer INSTANCE = new ZDT2LDTDeserializer();

	@Override
	public LocalDateTime deserialize(JsonParser parser, DeserializationContext ctx) throws IOException {
		ZonedDateTime result = InstantDeserializer.ZONED_DATE_TIME.deserialize(parser, ctx);
		if (result == null) {
			return null;
		}
