...
public class Instant2LDTDeserializer extends JsonDeserializer<LocalDateTime> {

	public static final Instant2LDTDeserializer INSTANCE = new Instant2LDTDeserializer();

	@Override
	public LocalDateTime deserialize(JsonParser parser, DeserializationContext ctx) throws IOException {
		Instant result = InstantDeserializer.INSTANT.deserialize(parser, ctx);
		if (result == null) {
			return null;
		}
