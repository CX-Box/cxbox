...
class SchedulerConfigTest {
	...
	void testQuartzScheduler() {
		SchedulerFactoryBean result = schedulerConfig.quartzScheduler(applicationContext, new CxboxBeanProperties(), Database.DEFAULT);
	...
	void testQuartzSchedulerService() {
		TransactionProxyFactoryBean result = schedulerConfig.quartzSchedulerService(
				schedulerConfig.quartzScheduler(applicationContext, new CxboxBeanProperties(), Database.DEFAULT)
		);
